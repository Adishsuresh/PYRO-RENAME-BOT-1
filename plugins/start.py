...
async def start(client, message):
    ...
    await message.reply_photo(
       ...
       reply_markup=InlineKeyboardMarkup( [[
           ...
           InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/FilmCube_MovieRequest'),
           InlineKeyboardButton('🍂 𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url='https://t.me/FilmCube_MovieRequest')
           ],[
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               ...
               InlineKeyboardButton("❣️ 𝚂𝙾𝚄𝚁𝙲𝙴", url="https://t.me/FilmCube_MovieRequest")
               ],[
               InlineKeyboardButton("❤️‍🔥 𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴  ❤️‍🔥", url='https://t.me/FilmCube_MovieRequest')
               ],[
