...
START_PIC = environ.get("START_PIC", "https://telegra.ph/file/bf0a0568ce00562ef0813.jpg")
...
async def start(client, message):
    ...
    await message.reply_photo(
       ...
       reply_markup=InlineKeyboardMarkup( [[
           ...
           InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/+DZeA7rbFodllMDY1'),
           InlineKeyboardButton('🍂 𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url='https://t.me/+DZeA7rbFodllMDY1')
           ],[
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               ...
               InlineKeyboardButton("❣️ 𝚂𝙾𝚄𝚁𝙲𝙴", url="https://t.me/+DZeA7rbFodllMDY1")
               ],[
               InlineKeyboardButton("❤️‍🔥 𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴  ❤️‍🔥", url='https://t.me/+DZeA7rbFodllMDY1')
               ],[
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               #⚠️ don't change source code & source link ⚠️ #
               InlineKeyboardButton("❣️ 𝚂𝙾𝚄𝚁𝙲𝙴", url="SOON...")
               ],[
               InlineKeyboardButton("🖥️ 𝙷𝙾𝚆 𝚃𝙾 𝙼𝙰𝙺𝙴", url="SOON..")
               ],[
               InlineKeyboardButton("🔒 𝙲𝙻𝙾𝚂𝙴", callback_data = "close"),
               InlineKeyboardButton("◀️ 𝙱𝙰𝙲𝙺", callback_data = "start")
               ]]
